...
class  RrcTfs : public virtual RrcDefs  // 10.3.5.23 Transport Format Set
{
    ...
    enum TransportFormatSet_PR mPresent;
    public:
    RrcTfs(TrChInfo *wtrch) : mTrChPtr(wtrch) {}
    RrcTfs* setDedicatedCh() { mPresent = TransportFormatSet_PR_dedicatedTransChTFS; return this; }
    RrcTfs* setCommonCh() { mPresent = TransportFormatSet_PR_commonTransChTFS; return this; }
